...
Lần trước, mình đã viết bài giới thiệu về kỹ thuật dùng hàm [Debounce](/tutorials/javascript-debounce-function-la-gi/). Nếu bạn có đọc các link trong phần tham khảo, hẵn sẽ thấy có nhắc đến hàm `throttle`. Hôm nay, mình sẽ giới thiệu về hàm này.
