...
pubDate: 2018-09-08
cover: "../../assets/tutorials/flexbox/thumbnails.jpg"
...
Giờ ta sẽ đi chi tiết về thuôc tính của element được bọc bởi element cha có thuộc tính `display: flex`. Đầu tiên, ta sẽ thử thuộc tính `grow`. Lưu ý, tổng của grow là **10** nhé.
