...
pubDate: 2024-01-06
cover: "../../assets/tutorials/fujifilm-x-raw-studio-va-file-fp1/fp1-content.png"
...
Có thể đọc lại bài viết tại [Fujifilm X Raw Studio và các giả lập màu phim](/tutorials/fujifilm-x-raw-studio-va-cac-gia-lap-mau-phim)

![FP1 Content](../../assets/tutorials/fujifilm-x-raw-studio-va-file-fp1/fp1-content.png)
...
![WB Shift](../../assets/tutorials/fujifilm-x-raw-studio-va-file-fp1/white-balance-shift.jpg)
</div>
